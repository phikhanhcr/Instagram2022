function ListSetting() {
  return (
    <ul className="hidden md:flex flex-col md:w-3/12 text-base border-r border-solid border-[#ccc]">
      <li className=" cursor-pointer opacity-60 hover:bg-gray-100 setting-option__active">
        <button href="#" className=" font-semibold block pl-8 py-4">
          Chỉnh sửa trang cá nhân
        </button>
      </li>
      <li className=" cursor-pointer opacity-60 hover:bg-gray-100">
        <button href="#" className=" font-semibold block pl-8 py-4">
          Đổi mật khẩu
        </button>
      </li>
      ...
      <div className="cursor-pointer flex-1 text-[#0095f6] border-b border-solid border-[#ccc]">
        <button href="#" className=" font-semibold block pl-8 py-4">
          Chuyển sang tài khoản công việc
        </button>
      </div>
      <div className="max-h-[236px] h-[236px]">
        <div className="pl-8 pt-7 pr-5 pb-5">
          <div>
            <svg
              aria-label="Logo chữ và logo của nhóm ứng dụng của Facebook"
              height={12}
              viewBox="0 0 500 100"
              width={60}
            >
          ...
          <a href="/" className="block mt-4 text-[#0095f6] font-semibold">
            Trung tâm tài khoản
          </a>
          <div className="text-xs mt-3">
            Kiểm soát các cài đặt về trải nghiệm kết nối trên Instagram, ứng
            dụng Facebook và Messenger, bao gồm tính năng chia sẻ tin, bài viết
            và đăng nhập.
          </div>
        </div>
      </div>
