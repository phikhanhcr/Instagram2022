...
function PostMobile({
  ...
  onClickShowModelComment,
}) {
 
  return (
    <>
      <div
        className={checkModelCommentMobile ? "hidden md:hidden" : "block md:hidden"}
      >
        <div className=" w-full max-h-screen overflow-hidden h-auto bg-[#fff] rounded-lg">
          ...
          <div className="flex justify-between px-4 pt-1">
            <div className="flex">
              ...
              <div onClick={() => onClickShowModelComment()} className="p-2 cursor-pointer">
                <svg
      ...
      {checkModelCommentMobile && <ViewComment onClickShowModelComment={onClickShowModelComment} />}
    </>
  );
}
