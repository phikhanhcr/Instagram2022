...
function InputMessage() {
  ...
  return (
    ...
    <div className="fixed bottom-0 right-0 left-0 md:relative bg-white h-[3.75rem] md:h-13 p-2 ">
      <div className="flex rounded-3xl items-center border border-solid border-[#ccc] px-4">
        ...
        <div className="flex-1">
          <input
            type="text"
            className="py-2.5 outline-none pl-3 w-[90%] text-sm"
